...
srlogo.reveal('.two-svg', { origin: 'bottom', opacity: '0', delay: '300', scale: '0'});
srlogo.reveal('.three-svg', { origin: 'bottom', opacity: '0', delay: '600', scale: '0'});
srlogo.reveal('.four-svg', { origin: 'bottom', opacity: '0', delay: '900', scale: '0'});
