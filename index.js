...
srlogo.reveal('.one-svg', { origin: 'bottom', opacity: '0', delay: '400', scale: '0'});
srlogo.reveal('.two-svg', { origin: 'bottom', opacity: '0', delay: '600', scale: '0'});
srlogo.reveal('.three-svg', { origin: 'bottom', opacity: '0', delay: '800', scale: '0'});
srlogo.reveal('.four-svg', { origin: 'bottom', opacity: '0', delay: '1000', scale: '0'});
srlogo.reveal('.five-svg', { origin: 'bottom', opacity: '0', delay: '1200', scale: '0'});
